            ...
            @php
                $navGroups = [
                    ...
                    'Académique' => [
                        ...
                        [
                            'label'      => 'Absences',
                            'route'      =>  auth()->user()->hasRole('parent') ? 'absences.parent' : 'absences.index',
                        ...
                        [
                            ...
                            'route' => match(true) {
                                auth()->user()->hasRole('parent')     => 'timetable.parent',
                                auth()->user()->hasRole('enseignant') => 'timetable.enseignant',
                                default                               => 'timetable.index',
                            },
